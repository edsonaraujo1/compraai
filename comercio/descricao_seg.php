...
<div id="Image4_container" style=" width: 166;  height: 32; overflow: hidden;" ><a href="javascript:;" onClick="MM_openBrWindow('fotos.php?cod_prod=<?php =$id_prod;?>','','scrollbars=yes,width=350,height=400,left=1o,top=10')"><img id="Image4" src="../graphics/ver_fotos.png"  width="166"  height="32"  border="0"       /></a></div>
</div>
...
<div id="Label15" style=" font-family: Verdana; font-size: 13px;  background-color: #FFFFFF;height:16px;width:124px;"   ><STRONG><?php =trim($nome_user_1);?></STRONG></div>
</div>
<div id="Label5_outer" style="Z-INDEX: 24; LEFT: 441px; WIDTH: 100px; POSITION: absolute; TOP: 103px; HEIGHT: 15px">
<div id="Label5" style=" font-family: Verdana; font-size: 13px;  background-color: #FFFFFF;height:15px;width:215px;"   ><STRONG><?php =$tipo;?></STRONG></div>
</div>

<div id="Label8_outer" style="Z-INDEX: 26; LEFT: 442px; WIDTH: 136px; POSITION: absolute; TOP: 140px; HEIGHT: 15px">
<div id="Label8" style=" font-family: Verdana; font-size: 13px;  background-color: #FFFFFF;height:15px;width:136px;"   ><STRONG><?php =$visitas;?></STRONG></div>
</div>
